...
{
    return GetBoolArg("-testnet", false) ? 18345 : 43102;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop EquiTrader server (and possibly override the detachdb config value).");
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("EquiTrader-rpclist");
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("EquiTrader-rpchand");
