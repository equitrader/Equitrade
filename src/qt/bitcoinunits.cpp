...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("EquiTraders"));
    case mBTC: return QString(QObject::tr("Milli-EquiTraders (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-EquiTraders (1 / 1,000,000)"));
    default: return QString("???");
    }
}
